...
for i in range(len(cities)):
    ...
    fig1.suptitle(f"{cities[i]} XDSClassifier")
    fig1.savefig(
        f"plot_part/{cities[i]}XDSClassifier_1.pdf")
    fig2.suptitle(f"{cities[i]} XDSClassifier")
    fig2.savefig(
        f"plot_part/{cities[i]}XDSClassifier_2.pdf")
    fig3.suptitle(f"{cities[i]} XDSClassifier")
    fig3.savefig(
        f"plot_part/{cities[i]}XDSClassifier_3.pdf")
    fig4.suptitle(f"{cities[i]} XDSClassifier")
    fig4.savefig(
        f"plot_part/{cities[i]}XDSClassifier_4.pdf")
    ax1.clear()
    ax2.clear()
    ax3.clear()
    ax4.clear()
    ...
    print(f"{cities[i]} EnsembleClassifier {par} {test_score}")
