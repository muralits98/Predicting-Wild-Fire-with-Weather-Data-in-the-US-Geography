...
\begin{table}[H]
    ...
    \begin{tabular}{|r|r|r|r|r|r|r|r|r|}
        ...
        &bal\_acc\\
        \hline
        &XGBClassifier &\multicolumn{2}{|r|}{96} &0.5000 &0.5000\\
        \hline
        &RandomForestClassifier &\multicolumn{2}{|r|}{41} &0.5307 &0.6196\\
        \hline
        \hline
        ...
        &bal\_acc\\
        \hline
        &XGBClassifier &\multicolumn{2}{|r|}{96} &0.6766 &0.6790\\
        \hline
        &RandomForestClassifier &\multicolumn{2}{|r|}{41} &0.6632 &0.7089\\
        \hline
    \end{tabular}
\end{table}
...
\begin{figure}[H]
    ...
    \foreach \i in {1,4} {%
        \begin{subfigure}[t]{0.45\textwidth}
            ...
            {../../analysis/yi/plot_zero_part/SanFranciscoRandomForestClassifier_\i.pdf}
        \end{subfigure}
    }
\end{figure}
...
\begin{figure}[H]
    ...
    \foreach \i in {1,4} {%
        \begin{subfigure}[t]{0.45\textwidth}
            \centering
            \includegraphics[width=0.8\textwidth]
            {../../analysis/yi/plot/SanFranciscoRandomForestClassifier_\i.pdf}
        \end{subfigure}
    }
\end{figure}
...
\begin{table}[H]
    ...
    \begin{tabular}{|r|r|r|r|r|r|r|r|r|}
        ...
        &bal\_acc\\
        \hline
        &XGBClassifierBS &2 &96 &0.6766 &0.6790\\
        \hline
        &RandomForestClassifierBS &2 &41 &0.6632 &0.7089\\
        \hline
        \hline
        ...
        &bal\_acc\\
        \hline
        &EnsembleClassifier &\multicolumn{2}{|r|}{96} &0.6857 &0.6766\\
        \hline
        &XDSClassifier &\multicolumn{2}{|r|}{96} &0.6843 &0.6925\\
        \hline
    \end{tabular}
\end{table}
...
\begin{figure}[H]
    ...
    \foreach \i in {1,4} {%
        \begin{subfigure}[t]{0.45\textwidth}
            \centering
            \includegraphics[width=0.8\textwidth]
            {../../analysis/yi/classify_boost/plot_part/SanFranciscoRandomForestClassifierBS_\i.pdf}
        \end{subfigure}
    }
\end{figure}
...
\begin{figure}[H]
    ...
    \foreach \i in {1,4} {%
        \begin{subfigure}[t]{0.45\textwidth}
            \centering
            \includegraphics[width=0.8\textwidth]
            {../../analysis/yi/classify_boost_multiordinal/plot_part/SanFranciscoRandomForestClassifierBS_\i.pdf}
        \end{subfigure}
    }
\end{figure}
...
\begin{figure}[H]
    ...
    \foreach \i in {1,4} {%
        \begin{subfigure}[t]{0.45\textwidth}
            \centering
            \includegraphics[width=0.8\textwidth]
            {../../analysis/yi/classify_xds/plot_part/SanFranciscoXDSClassifier_\i.pdf}
        \end{subfigure}
    }
\end{figure}
